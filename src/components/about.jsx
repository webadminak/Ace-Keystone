  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Learn about AK Consultants – a forward-thinking company which have been functioning since 2022 and officially registered in 2025, dedicated to delivering innovative, scalable solutions in AI, smart infrastructure, and business strategy." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.ak-consultants.in/about.html" />

        {/* Open Graph for better social preview */}
        <meta property="og:title" content="About Us | AK Consultants" />
        <meta property="og:description" content="Discover our mission and team at AK Consultants, delivering excellence through innovation since 2022." />
        <meta property="og:image" content="https://www.ak-consultants.in/static/media/about-us.eeddcd253edfca07c2a0.jpg" />
        <meta property="og:url" content="https://www.ak-consultants.in/about.html" />
        ...
        <meta name="twitter:image" content="https://www.ak-consultants.in/static/media/about-us.eeddcd253edfca07c2a0.jpg" />
      </Helmet>
        ...
        <div className={styles.stackedSection}>
          ...
          <div className={styles.textCard} data-aos="fade-up">
            ...
            <p>
              ...
              meaningful transformation. Functioning since 2022 and officially registered in 2025, our mission is to solve real-world problems using forward-thinking,
              scalable solutions.
            </p>
            <p>
      ...
      <div className={styles.missionSection} >
        ...
        <p data-aos="fade-up">
          AK consultants were established with the aim of deriving and
